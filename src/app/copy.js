...
export const COPY = {
  en: {
    ...
    layers: 'Layers', addLayer: 'Add layer', addElement: 'Add element', fromImage: 'Add from image', fromSvgCollection: 'Add from SVG collection', commonShapes: 'Common', svgCollectionTitle: 'SVG collection', svgCollectionThemes: 'SVG themes', svgCollectionCompanyLogos: 'Company logos', svgCollectionAnimationExamples: 'Animation examples', svgCollectionAnimationPack: 'Animation pack', svgCollectionLoadingCases: 'Loading cases', svgCollectionUniqueAnimations: 'Unique animations', svgCollectionItems: 'items', svgCollectionSource: 'View source', svgCollectionAdd: 'Add', loadDemo: 'Load demo SVG', textContent: 'Text content', editText: 'Edit text content', fontSize: 'Font size', letterSpacing: 'Character spacing', fontFamily: 'Font family', fontFamilyDefault: 'SVG default', fontFamilyPlaceholder: 'e.g. Arial, sans-serif', bold: 'Bold',
    preview: 'Preview', source: 'Source', format: 'Format', copySource: 'Copy source', editSource: 'Edit source', sourceTree: 'SVG source tree', collapsedContent: 'Collapsed content', resetView: 'Reset view and center', collapseLayers: 'Collapse layers', expandLayers: 'Expand layers', collapseInspector: 'Collapse properties', expandInspector: 'Expand properties', dropHint: 'Drop an SVG anywhere to begin', inspector: 'Inspector', appearance: 'Appearance',
    fill: 'Fill', stroke: 'Stroke', opacity: 'Opacity', strokeWidth: 'Stroke width', cornerRadius: 'Corner radius', polygonSides: 'Sides', width: 'Width', height: 'Height', aspectRatio: 'Aspect ratio', aspectRatioOriginal: 'Original', gradient: 'Gradient', gradientStart: 'Start color', gradientEnd: 'End color', gradientAngle: 'Angle', colorTokens: 'Color tokens', colorTokenUsage: 'uses', colorTokensEmpty: 'No color tokens found in this SVG.', copyColor: 'Copy color', editColor: 'Edit color', copied: 'Copied', elementDetails: 'Element details', layer: 'Layer', visibility: 'Visibility',
    ...
    exportDialogTitle: 'Export', exportFormat: 'Format', exportScope: 'Export scope', exportAllLayers: 'Export all layers', exportSelectedLayers: 'Export selected layers', exportScale: 'Scale', exportOptimize: 'Optimize & minify SVG', exportPreview: 'Preview', exportEstimatedSize: 'Est. size', exportFailed: 'Export failed',
  ...
  'zh-CN': {
    ...
    layers: '图层', addLayer: '添加图层', addElement: '添加元素', fromImage: '图片', fromSvgCollection: 'SVG 收藏', commonShapes: '常用', svgCollectionTitle: 'SVG 收藏', svgCollectionThemes: 'SVG 主题', svgCollectionCompanyLogos: '公司 Logo', svgCollectionAnimationExamples: '动画示例', svgCollectionAnimationPack: '动画组合', svgCollectionLoadingCases: '加载动画', svgCollectionUniqueAnimations: '创意动画', svgCollectionItems: '个项目', svgCollectionSource: '查看来源', svgCollectionAdd: '添加', loadDemo: '加载 Demo SVG', textContent: '文字内容', editText: '编辑文字内容', fontSize: '字体大小', letterSpacing: '字符间距', fontFamily: '字体家族', fontFamilyDefault: 'SVG 默认字体', fontFamilyPlaceholder: '例如 Arial, sans-serif', bold: '加粗',
    preview: '预览', source: '源码', format: '格式化', copySource: '复制源码', editSource: '编辑源码', sourceTree: 'SVG 源码树', collapsedContent: '已折叠内容', resetView: '重置视图并居中', collapseLayers: '折叠图层面板', expandLayers: '展开图层面板', collapseInspector: '折叠属性面板', expandInspector: '展开属性面板', dropHint: '将 SVG 拖到这里开始', inspector: '检查器', appearance: '外观',
    fill: '填充', stroke: '描边', opacity: '不透明度', strokeWidth: '描边宽度', cornerRadius: '圆角半径', polygonSides: '边数', width: '宽度', height: '高度', aspectRatio: '图层比例', aspectRatioOriginal: '原始', gradient: '渐变色', gradientStart: '起始颜色', gradientEnd: '结束颜色', gradientAngle: '角度', colorTokens: '颜色 Token', colorTokenUsage: '次使用', colorTokensEmpty: '当前 SVG 中没有颜色 Token。', copyColor: '复制颜色', editColor: '编辑颜色', copied: '已复制', elementDetails: '元素详情', layer: 'Layer', visibility: '可见性',
    ...
    toastExported: 'SVG 已导出', toastImported: '已导入', toastCopy: '已复制图层', toastPaste: '已粘贴图层', toastDelete: '已删除图层 — 按 ⌘Z 撤销', toastFormatted: '源码已格式化', toastSourceCopied: '源码已复制', toastSourceCopyFailed: '无法复制源码', toastInvalidFile: '请拖入或选择一个 SVG 文件。', toastInvalidImageFile: '请选择受支持的图片文件。', toastCollectionImportFailed: '无法导入此 SVG 收藏图标。',
    ...
    exportDialogTitle: '导出', exportFormat: '格式', exportScope: '导出范围', exportAllLayers: '导出整个图层', exportSelectedLayers: '导出选择图层', exportScale: '倍率', exportOptimize: '优化并压缩 SVG', exportPreview: '预览', exportEstimatedSize: '预计大小', exportFailed: '导出失败',
  ...
  'zh-TW': {
    ...
    layers: '圖層', addLayer: '新增圖層', addElement: '新增元素', fromImage: '圖片', fromSvgCollection: 'SVG 收藏', commonShapes: '常用', svgCollectionTitle: 'SVG 收藏', svgCollectionThemes: 'SVG 主題', svgCollectionCompanyLogos: '公司 Logo', svgCollectionAnimationExamples: '動畫範例', svgCollectionAnimationPack: '動畫組合', svgCollectionLoadingCases: '載入動畫', svgCollectionUniqueAnimations: '創意動畫', svgCollectionItems: '個項目', svgCollectionSource: '查看來源', svgCollectionAdd: '新增', loadDemo: '載入 Demo SVG', textContent: '文字內容', editText: '編輯文字內容', fontSize: '字體大小', letterSpacing: '字元間距', fontFamily: '字體家族', fontFamilyDefault: 'SVG 預設字體', fontFamilyPlaceholder: '例如 Arial, sans-serif', bold: '粗體',
    preview: '預覽', source: '原始碼', format: '格式化', copySource: '複製原始碼', editSource: '編輯原始碼', sourceTree: 'SVG 原始碼樹', collapsedContent: '已摺疊內容', resetView: '重置視圖並置中', collapseLayers: '摺疊圖層面板', expandLayers: '展開圖層面板', collapseInspector: '摺疊屬性面板', expandInspector: '展開屬性面板', dropHint: '將 SVG 拖到這裡開始', inspector: '檢查器', appearance: '外觀',
    fill: '填色', stroke: '描邊', opacity: '不透明度', strokeWidth: '描邊寬度', cornerRadius: '圓角半徑', polygonSides: '邊數', width: '寬度', height: '高度', aspectRatio: '圖層比例', aspectRatioOriginal: '原始', gradient: '漸層色', gradientStart: '起始顏色', gradientEnd: '結束顏色', gradientAngle: '角度', colorTokens: '顏色 Token', colorTokenUsage: '次使用', colorTokensEmpty: '目前 SVG 中沒有顏色 Token。', copyColor: '複製顏色', editColor: '編輯顏色', copied: '已複製', elementDetails: '元素詳情', layer: 'Layer', visibility: '可見性',
    ...
    toastExported: 'SVG 已匯出', toastImported: '已匯入', toastCopy: '已複製圖層', toastPaste: '已貼上圖層', toastDelete: '已刪除圖層 — 按 ⌘Z 復原', toastFormatted: '原始碼已格式化', toastSourceCopied: '原始碼已複製', toastSourceCopyFailed: '無法複製原始碼', toastInvalidFile: '請拖入或選擇一個 SVG 檔案。', toastInvalidImageFile: '請選擇支援的圖片檔案。', toastCollectionImportFailed: '無法匯入此 SVG 收藏圖示。',
    ...
    exportDialogTitle: '匯出', exportFormat: '格式', exportScope: '匯出範圍', exportAllLayers: '匯出整個圖層', exportSelectedLayers: '匯出選取圖層', exportScale: '倍率', exportOptimize: '最佳化並壓縮 SVG', exportPreview: '預覽', exportEstimatedSize: '預計大小', exportFailed: '匯出失敗',
  ...
  ja: {
    ...
    layers: 'レイヤー', addLayer: 'レイヤーを追加', addElement: '要素を追加', fromImage: '画像', fromSvgCollection: 'SVG コレクション', commonShapes: '図形', svgCollectionTitle: 'SVG コレクション', svgCollectionThemes: 'SVG テーマ', svgCollectionCompanyLogos: '企業ロゴ', svgCollectionAnimationExamples: 'アニメーション例', svgCollectionAnimationPack: 'アニメーションパック', svgCollectionLoadingCases: 'ローディング', svgCollectionUniqueAnimations: 'ユニークアニメーション', svgCollectionItems: '個のアイテム', svgCollectionSource: 'ソースを見る', svgCollectionAdd: '追加', loadDemo: 'デモ SVG を読み込む', textContent: 'テキスト内容', editText: 'テキストを編集', fontSize: 'フォントサイズ', letterSpacing: '文字間隔', fontFamily: 'フォントファミリー', fontFamilyDefault: 'SVG のデフォルト', fontFamilyPlaceholder: '例: Arial, sans-serif', bold: '太字',
    preview: 'プレビュー', source: 'ソース', format: '整形', copySource: 'ソースをコピー', editSource: 'ソースを編集', sourceTree: 'SVG ソースツリー', collapsedContent: '折りたたまれた内容', resetView: 'ビューをリセットして中央に', collapseLayers: 'レイヤーパネルを折りたたむ', expandLayers: 'レイヤーパネルを展開', collapseInspector: 'プロパティパネルを折りたたむ', expandInspector: 'プロパティパネルを展開', dropHint: 'SVG をここにドロップして開始', inspector: 'インスペクター', appearance: '外観',
    fill: '塗りつぶし', stroke: 'ストローク', opacity: '不透明度', strokeWidth: 'ストローク幅', cornerRadius: '角丸半径', polygonSides: '辺の数', width: '幅', height: '高さ', aspectRatio: 'アスペクト比', aspectRatioOriginal: '元の比率', gradient: 'グラデーション', gradientStart: '開始色', gradientEnd: '終了色', gradientAngle: '角度', colorTokens: 'カラートークン', colorTokenUsage: '回使用', colorTokensEmpty: 'この SVG にはカラートークンがありません。', copyColor: '色をコピー', editColor: '色を編集', copied: 'コピーしました', elementDetails: '要素の詳細', layer: 'レイヤー', visibility: '表示状態',
    ...
    exportDialogTitle: 'エクスポート', exportFormat: 'フォーマット', exportScope: 'エクスポート範囲', exportAllLayers: 'すべてのレイヤー', exportSelectedLayers: '選択したレイヤー', exportScale: '倍率', exportOptimize: 'SVG を最適化・圧縮', exportPreview: 'プレビュー', exportEstimatedSize: '推定サイズ', exportFailed: 'エクスポートに失敗しました',
