...
export const COPY = {
  en: {
    ...
    menuRename: 'Rename', renamePlaceholder: 'Layer name', svgName: 'SVG name', editSvgName: 'Rename SVG', recentSvgs: 'Recent SVGs', recentSvgsEmpty: 'No edited SVGs yet.', recentSvgPreview: 'SVG preview', expandRecentSvgPreview: 'Expand SVG preview', removeRecentSvg: 'Remove from recent SVGs',
  ...
  'zh-CN': {
    ...
    menuRename: '重命名', renamePlaceholder: '图层名称', svgName: 'SVG 名称', editSvgName: '编辑 SVG 名称', recentSvgs: '历史 SVG 列表', recentSvgsEmpty: '暂时没有编辑过的 SVG。', recentSvgPreview: 'SVG 预览', expandRecentSvgPreview: '放大 SVG 预览', removeRecentSvg: '删除历史 SVG',
  ...
  'zh-TW': {
    ...
    menuRename: '重新命名', renamePlaceholder: '圖層名稱', svgName: 'SVG 名稱', editSvgName: '編輯 SVG 名稱', recentSvgs: '歷史 SVG 列表', recentSvgsEmpty: '暫時沒有編輯過的 SVG。', recentSvgPreview: 'SVG 預覽', expandRecentSvgPreview: '放大 SVG 預覽', removeRecentSvg: '刪除歷史 SVG',
  ...
  ja: {
    ...
    menuRename: '名前を変更', renamePlaceholder: 'レイヤー名', svgName: 'SVG 名', editSvgName: 'SVG 名を編集', recentSvgs: 'SVG 履歴', recentSvgsEmpty: '編集した SVG はまだありません。', recentSvgPreview: 'SVG プレビュー', expandRecentSvgPreview: 'SVG プレビューを拡大', removeRecentSvg: 'SVG 履歴から削除',
