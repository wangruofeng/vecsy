...
export const COPY = {
  ...
  'zh-TW': {
    ...
    layers: '圖層', addLayer: '新增圖層', addElement: '新增元素', fromImage: '圖片', fromSvgCollection: 'SVG 收藏', commonShapes: '常用', svgCollectionTitle: 'SVG 收藏', svgCollectionThemes: 'SVG 主題', svgCollectionCompanyLogos: '公司 Logo', svgCollectionSocialMedia: '社交媒體', svgCollectionPopularLogos: '熱門 Logo', svgCollectionAnimationExamples: '動畫範例', svgCollectionAnimationPack: '動畫組合', svgCollectionLoadingCases: '載入動畫', svgCollectionSvgSpinners: 'SVG 旋轉載入', svgCollectionUniqueAnimations: '創意動畫', svgCollectionCustom: '我的 SVG', svgCollectionAddCustom: '新增 SVG', svgCollectionCustomName: '名稱（可選）', svgCollectionCustomMarkup: '貼上 SVG 原始碼', svgCollectionSaveCustom: '儲存 SVG', svgCollectionRemoveCustom: '刪除', svgCollectionCustomDefaultName: '自訂 SVG', svgCollectionInvalidCustom: '請貼上有效的 SVG 原始碼。', svgCollectionItems: '個項目', svgCollectionSource: '查看來源', svgCollectionAdd: '新增', loadDemo: '載入 Demo SVG', textContent: '文字內容', editText: '編輯文字內容', fontSize: '字體大小', letterSpacing: '字元間距', fontFamily: '字體家族', fontFamilyDefault: 'SVG 預設字體', fontFamilyPlaceholder: '例如 Arial, sans-serif', bold: '粗體',
