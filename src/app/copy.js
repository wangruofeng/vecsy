...
const SECTIONS = {
  ...
  ai: {
    ...
    aiJsonPlaceholder: {
      'en': 'Paste a complete VDAP 1.0 envelope',
      'zh-CN': '粘贴完整的 VDAP 1.0 Envelope',
      'zh-TW': '貼上完整的 VDAP 1.0 Envelope',
      'ja': '完全な VDAP 1.0 Envelope を貼り付け',
    },
    aiSubmitJson: {
      'en': 'Preview JSON',
      'zh-CN': '预览 JSON',
    ...
    aiErrorUnsupportedProtocolVersion: {
      'en': 'Unsupported protocol version.',
      'zh-CN': '不支持的协议版本。',
      'zh-TW': '不支援的協定版本。',
      'ja': '未対応のプロトコルバージョンです。',
    },
    aiErrorInvalidAction: {
      'en': 'The edit action is invalid.',
      'zh-CN': '编辑操作无效。',
      'zh-TW': '編輯操作無效。',
      'ja': '編集アクションが無効です。',
    },
    aiErrorUnknownTarget: {
      'en': 'An edit target no longer exists.',
      'zh-CN': '编辑目标不存在。',
      'zh-TW': '編輯目標不存在。',
      'ja': '編集対象が存在しません。',
    },
    aiErrorOutOfSelectionTarget: {
      'en': 'AI can only edit the current selection.',
      'zh-CN': 'AI 只能修改当前选中元素。',
      'zh-TW': 'AI 只能修改目前選取的元素。',
      'ja': 'AI は現在の選択範囲のみ編集できます。',
    },
    aiErrorDocumentChanged: {
      'en': 'Document changed while AI was working.',
      'zh-CN': 'AI 处理期间文档已更改。',
      'zh-TW': 'AI 處理期間文件已變更。',
      'ja': 'AI の処理中にドキュメントが変更されました。',
    },
    aiErrorProviderNotConfigured: {
      'en': 'AI service is not configured or the API key was rejected.',
      'zh-CN': 'AI 服务未配置或密钥无效。',
      'zh-TW': 'AI 服務未設定或金鑰無效。',
      'ja': 'AI サービスが未設定か、API キーが無効です。',
    },
    aiErrorRequestFailed: {
      'en': 'The AI service could not be reached.',
      'zh-CN': '无法连接 AI 服务。',
      'zh-TW': '無法連線 AI 服務。',
      'ja': 'AI サービスに接続できませんでした。',
    },
    aiErrorRateLimited: {
      'en': 'The AI service is temporarily rate limited.',
      'zh-CN': 'AI 服务暂时达到请求限制。',
      'zh-TW': 'AI 服務暫時達到請求限制。',
      'ja': 'AI サービスのリクエスト制限に達しました。',
    },
    aiErrorTimeout: {
      'en': 'The AI service timed out.',
      'zh-CN': 'AI 服务请求超时。',
      'zh-TW': 'AI 服務要求逾時。',
      'ja': 'AI サービスがタイムアウトしました。',
    },
    aiSettingsTitle: {
    ...
    aiSettingsDesc: {
      'en': 'Manage AI model entries for editing. The API key is stored locally in your browser and never uploaded.',
      'zh-CN': '管理用于 AI 编辑的模型配置。API Key 仅保存在浏览器本地，不会上传。',
      'zh-TW': '管理用於 AI 編輯的模型設定。API Key 僅存在瀏覽器本機，不會上傳。',
      'ja': 'AI 編集に使用するモデル設定を管理します。API Key はブラウザにローカル保存され、アップロードされません。',
    },
    aiProviderName: {
      'en': 'Provider name',
      'zh-CN': '供应商名称',
    ...
    aiApiFormatChat: {
      'en': 'Chat Completions (/chat/completions)',
      'zh-CN': 'Chat Completions (/chat/completions)',
      'zh-TW': 'Chat Completions (/chat/completions)',
      'ja': 'Chat Completions (/chat/completions)',
    },
    aiApiFormatAnthropic: {
      'en': 'Anthropic Messages (/v1/messages)',
      'zh-CN': 'Anthropic Messages (/v1/messages)',
      'zh-TW': 'Anthropic Messages (/v1/messages)',
      'ja': 'Anthropic Messages (/v1/messages)',
    },
    aiApiFormatResponses: {
      'en': 'Responses (/responses)',
      'zh-CN': 'Responses (/responses)',
      'zh-TW': 'Responses (/responses)',
      'ja': 'Responses (/responses)',
    },
    aiApiKey: {
      'en': 'API Key',
      'zh-CN': 'API Key',
    ...
    aiFormatTagAnthropic: {
      'en': 'Anthropic',
      'zh-CN': 'Anthropic',
      'zh-TW': 'Anthropic',
      'ja': 'Anthropic',
    },
    aiFormatTagResponses: {
      'en': 'Responses',
      'zh-CN': 'Responses',
      'zh-TW': 'Responses',
      'ja': 'Responses',
    ...
    aiModelsEmpty: {
      'en': 'No model entries yet. Add one to enable AI editing.',
      'zh-CN': '暂无模型配置，新增一个以启用 AI 编辑。',
      'zh-TW': '尚無模型設定，新增一個以啟用 AI 編輯。',
      'ja': 'モデル設定がありません。AI 編集には追加が必要です。',
    },
    aiRemoveModel: {
      'en': 'Remove model',
      'zh-CN': '删除模型',
    ...
    aiNoModelError: {
      'en': 'Add at least one model.',
      'zh-CN': '请至少添加一个模型。',
      'zh-TW': '請至少新增一個模型。',
      'ja': '少なくとも 1 つのモデルを追加してください。',
    },
    aiNoChange: {
      'en': 'The AI actions match the current document — applying them would change nothing. Try a different request.',
      'zh-CN': 'AI 动作与当前文档内容一致，应用后不会有任何变化。请换个说法再试。',
      'zh-TW': 'AI 動作與目前文件內容一致，套用後不會有任何變化。請換個說法再試。',
      'ja': 'AI の操作は現在のドキュメントと同一のため、適用しても変化はありません。別の指示をお試しください。',
    },
  },
}
