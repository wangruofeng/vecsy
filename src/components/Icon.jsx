export default function Icon({ name, size = 16 }) {
  const paths = {
    ...
    globe: <><circle cx="8" cy="8" r="6.1" /><path d="M1.9 8h12.2" /><path d="M8 1.9c1.7 1.6 2.6 3.7 2.6 6.1s-.9 4.5-2.6 6.1c-1.7-1.6-2.6-3.7-2.6-6.1S6.3 3.5 8 1.9Z" /></>,
    minus: <path d="M3 8h10" />,
    play: <path d="m5.5 3.5 6 4.5-6 4.5V3.5Z" fill="currentColor" stroke="none" />,
    pause: <><path d="M5 3.5v9" /><path d="M11 3.5v9" /></>,
