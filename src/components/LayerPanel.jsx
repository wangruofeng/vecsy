...
export default function LayerPanel(props) {
  ...
  const selectLayerRange = (targetId) => {
    ...
    selectLayerIds(visibleLayerItems.slice(start, end + 1).map(({ item }) => item.id), targetId)
  }
  return (
